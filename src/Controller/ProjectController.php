...
class ProjectController extends AbstractController
{
    ...
    public function addProject(
        ...
        return $this->render('admin/project/addProject.html.twig', ['form' => $projectForm->createView()]);
    }
    ...
    {
        return $this->render('admin/project/showProject.html.twig', ['project' => $project]);
    }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($photoFile1 != null) {
                if($project->getPhotos()[0] != null) {
                    $fileManager->deleteFile($project->getPhotos()[0]->getPhoto(), $this->getParameter('upload_directory'));                   
                    $entityManager->remove($project->getPhotos()[0]);
                }
            ...
            if ($photoFile2 != null) {
                if($project->getPhotos()[1] != null) {
                    $fileManager->deleteFile($project->getPhotos()[1]->getPhoto(), $this->getParameter('upload_directory'));
                    $entityManager->remove($project->getPhotos()[1]);
                }
            ...
            if ($photoFile3 != null) {
                if($project->getPhotos()[2] != null) {
                    $fileManager->deleteFile($project->getPhotos()[2]->getPhoto(), $this->getParameter('upload_directory'));
                    $entityManager->remove($project->getPhotos()[2]);
                }
